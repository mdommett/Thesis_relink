...
\usepackage[left=45mm,right=30mm]{geometry}
...
\include{6Conclusions/conclusions}
...
\centering
 ...
 \caption[The vacuum PES of \textbf{HC1} \& \textbf{HC5}]{The critical points on the \ac{PES} of \textbf{HC1} \& \textbf{HC5} obtained at (TD-)$\omega$BX-D/6-31G(d) in vacuum.}
...
\begin{table}[H]
\centering
\caption{Radiative rates $k_{r,}$ in the enol (E*) and keto (k*) regimes for \textbf{HC1}, \textbf{HC5}, \textbf{HP1}. All rates in \SI{}{s^{-1}}, calculated at TD-$\omega$B97X-D/6-31G(d):AMBER level using the Einstein relationship of Equation \ref{equation: Einstein_rate}.} 
  \label{table: rates}
  \begin{tabular}{lll}
  \hline
  System & $k_{r,E*}$ & $k_{r,K*}$\\
  \hline
  \textbf{HC1} & \SI{1.78e9}{} & \SI{2.83e8}{} \\
  \textbf{HC5} & - & \SI{1.02e8}{} \\
  \textbf{HP1} & \SI{4.49E6}{} & \SI{1.23e8}{} \\
  \hline
  \end{tabular}
\end{table}
\end{comment}
